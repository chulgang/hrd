                        ...
                        <div class="menu_area alt-font">
                            <nav class="navbar navbar-expand-lg navbar-light p-0">
                                ...
                                <ul class="navbar-nav ms-auto" id="nav" style="display: none;">
                                    ...
                                    <li><a href="#!">Events</a>
                                        <ul>
                                            <li><a href="event-list.html">예약 목록</a></li>
                                ...
                                <div class="p-1-6 p-sm-1-9">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center">
                                        <p class="mb-0 text-primary font-weight-600">
                                            ...
                                            <span class="text-primary">${reservation.startDate}</span>
                                        </p>
                                        <p class="mb-0 text-primary font-weight-600">
                                            <i class="ti-money me-2"></i>
                                            <span class="text-primary">${reservation.price}</span>
                                        </p>
                                        <p class="mb-0 text-primary font-weight-600">
                                            <i class="ti-star me-2"></i>
                                            <span class="text-primary">${reservation.averageScore}</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="ps-md-1-9">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                <h4 class="h6 mb-2"><a href="blog-details.html"
                                                       class="text-white text-primary-hover">A supportive learning community</a>
                                </h4>
