                            ...
                            <div>
                                ...
                                <c:choose>
                                   <c:when test="${empty dto}">
                                        <tr>
                                            <td class="text-left" onclick="location.href='login/login.do?m=form'">로그인<br/></td>
                                        </tr>
                                    </c:when>
                                    <c:otherwise>
                                        <td class="text-left" onclick="location.href='login/login.do?m=logout'"><font style ="color:Orange">${loginOkUser.name}</font>
                                            <font style="color:black">님 환영합니다.</font>
                                            <br/>로그아웃<br/></td>
                                    </c:otherwise>
                                </c:choose>
                            </div>
