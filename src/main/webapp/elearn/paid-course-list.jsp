                    ...
                    <div class="col-xl-6 mt-2-9">
                        <div class="row g-0 event-wrapper">
                            <div class="col-md-5 event-img bg-img cover-background"
                                 data-background="img/content/event-01.jpg">
                            </div>
                            <div class="col-md-7">
                                <div class="p-1-6 p-sm-1-9">
                                    <span class="badge-soft mb-3">${payment.courseName}</span>
                                    <h4 class="font-weight-800 h5 mb-3"><a href="event-details.html">${payment.courseName}</a></h4>
                ...
                <div class="col-md-6 col-lg-4">
                    <div class="ps-md-1-9">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body align-self-center">
                                <h4 class="h6 mb-2"><a href="blog-details.html"
                                                       class="text-white text-primary-hover">A
